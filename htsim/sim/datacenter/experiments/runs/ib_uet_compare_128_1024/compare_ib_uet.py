...
IB=f"{BASE}/ib_uet_compare_128_1024/results_ib.csv"
IBU=f"{BASE}/ib_uet_compare_128_1024/utilization_ib.csv"
UET=[f"{BASE}/all_workloads_128_1024/results_combined.csv", f"{BASE}/a2a_conc_128_1024/results_combined.csv"]
UETU=[f"{BASE}/all_workloads_128_1024/utilization_combined.csv", f"{BASE}/a2a_conc_128_1024/utilization_combined.csv"]
