...
OUT="$DC/experiments/runs/ib_dcqcn/perm_incast_a2a_128_1024"
...
case "$base" in
  incast_*|outcast_*|a2a_*) LOGTIME_US="${LOGTIME_COARSE_US:-20000}" ;;
esac

WORKROOT="${WORKROOT:-/media/mahmoud_murad_allaah/Data/ib_compare_work}"
work="$WORKROOT/${tag}"
